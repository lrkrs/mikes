...
.searchBar_e6b769 .searchBarComponent__35e86 {
...
.wrapper__00943.interactive_bf1984 {
...
.wrapper__6e9f8[data-list-item-id="guildsnav___home"] .childWrapper__6e9f8 {
  background: var(--darkplus-home-icon) center/cover no-repeat !important;
  min-width: 50px;
  min-height: 50px;
...
.background_a9178b .profile_d6fbe8 {
  padding: 16px;
}
.background_a9178b .fieldList_a9178b {
  padding: 16px;
  background-color: transparent;
}
.background_a9178b .constrainedRow_a9178b .button__201d5 {
  margin-left: 8px;
}
.layer__960e4  {
  background-color: var(--darkplus-bg);
...
.theme-dark .uploadModal_b78547 {
  background-color: var(--darkplus-bg);
}
.theme-dark .footer_b78547 {
  background-color: var(--darkplus-bg);
}
.size14-3fJ-ot {
  color: var(--darkplus-sec);
...
.field_a9178b > div > div > div {
  filter: blur(5px);
}
.field_a9178b > div > div > div:hover {
  filter: blur(0);
}
...
.overflowMenuIcon_a9178b {
  color: var(--darkplus-sec);
}

.username__05e81,
.discriminator_a9178b,
...
.headerText_aa8da2, .sidebar__23e6b .side_aa8da2 .item_aa8da2, .bd-sidebar-header h2 {
  color: var(--darkplus-sec);
}
...
.sprite__04eed.spriteGreyscale__04eed.inactive__04eed {
  background: var(--darkplus-sec);
}
...
.interactive_bf202d .highlighted__20a53 {
  background-color: color-mix(in srgb, var(--darkplus-sec) 40%, transparent);
  width: 100%;
}

.container__5e434, .visual-refresh .sidebar__5e434:after {
    background: var(--darkplus-bg) !important;
}
...
.title_c38106 .defaultColor__4bd52 {
	color: var(--darkplus-sec);
}
...
.visual-refresh .themed_aa8da2.item_aa8da2 {
    color: var(--darkplus-sec);
}
...
.nameTag__37e49  .title_b6c092, .nameTag__37e49 .subtext__339d0 {
  color: var(--darkplus-sec);
}
...
.menu_c1e9c4 .label_c1e9c4, .menu_c1e9c4 .iconContainer_c1e9c4 svg {
  color: var(--darkplus-sec);
}

.modeMuted__2ea32 .icon__2ea32, .modeMuted__2ea32 .name__2ea32 {
  color: var(--darkplus-links);
  opacity: .7;
}
...
.panels__5e434 {
  background-color: var(--darkplus-bg) !important;
  border: 2px solid var(--darkplus-sec) !important;
}
...
.visual-refresh .cozy_c19a55 .timestamp_c19a55, .user-profile-popout .nickname__63ed3, .user-profile-sidebar .nickname__63ed3, .userTagDiscriminator__63ed3 {
  color: var(--darkplus-sec);
}

.user-profile-sidebar .overlay_c0bea0 {
  background-color: var(--darkplus-bg);
}

.user-profile-sidebar .overlay_c0bea0 .defaultColor__5345c {
  color: var(--darkplus-sec) !important;
}

.user-profile-sidebar .overlay_c0bea0 .defaultColor__4bd52 {
  color: var(--darkplus-links);
}

.overlay_c0bea0 .header__1f6ca svg path{
  fill: var(--darkplus-sec) !important;
}

.lottieIconColors__5eb9b :not(defs *)[stroke][stroke-opacity] {
  stroke: var(--darkplus-sec) !important;
}

.clickable_c99c29, .lottieIcon__5eb9b {
  color: var(--darkplus-sec);
}
...
.sidebar__5e434, .sidebar__5e434:after, .bar_c38106 {
  background: var(--darkplus-bg) !important;
}
...
.numberBadge__463b7, .mentionsBar__7aaec {
  background-color: var(--darkplus-sec) !important;
  color: var(--darkplus-bg) !important;
}
